            ...
            <div className="bg-white h-fit w-full sm:max-w-[350px] p-5 rounded-lg">
                ...
                <div className="flex justify-between gap-2 flex-wrap">
                    <button
                        ...
                        className="px-5 py-2.5 rounded-lg text-red-300 border border-red-300 text-sm disabled:opacity-70"
                    >
                        Cancel
                    </button>
                    <button
                        ...
                        className="px-5 py-2.5 rounded-lg text-white bg-dark-third text-sm disabled:opacity-70"
                    >
                        Crop & Upload
                    </button>
                </div>
